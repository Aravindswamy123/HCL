...
import { FormControl, FormGroup, FormLabel, TextareaAutosize, TextField, Checkbox, FormControlLabel, Button } from '@mui/material';
...
export default function PatienceAdmission() {
    ...
    return <>        
        ...
        <Link style={{ textDecoration: 'none' }} to="/"><Button variant="outlined">Cancel</Button></Link>
